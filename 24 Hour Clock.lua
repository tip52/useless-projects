_G.loop = true -- settings loop to true
num1 = 0 -- creating number variables and setting them to 0
num2 = 0
num3 = 0
num4 = 0
num5 = 0
spawn(function() -- creating a function to run separately from script
    while _G.loop do -- creating loop
        task.wait() -- adding task.wait() (faster than wait()) to not crash game
...
spawn(function()  -- creating a function to run separately from script
    while _G.loop do -- creating loop
        task.wait(1) -- waiting 1 so that it's an actual timer
